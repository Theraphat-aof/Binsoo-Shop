...
const adminProductService = {
  createFlavor: async (flavorData) => {
    ...
    const response = await axios.post(`${API_BASE_URL}/flavors`, flavorData, {
      headers,
    });
  ...
  getFlavorById: async (id) => {
    const headers = getAuthHeaders();
    const response = await axios.get(`${API_BASE_URL}/flavors/${id}`, {
      headers,
    });
    return response.data;
  },
  ...
  deleteFlavor: async (id) => {
    const headers = getAuthHeaders();
    const response = await axios.delete(`${API_BASE_URL}/flavors/${id}`, {
      headers,
    });
    return response.data;
  },
  ...
  updateSize: async (id, sizeData) => {
    const headers = getAuthHeaders();
    const response = await axios.put(`${API_BASE_URL}/sizes/${id}`, sizeData, {
      headers,
    });
    return response.data;
  },
  ...
  getToppingById: async (id) => {
    const headers = getAuthHeaders();
    const response = await axios.get(`${API_BASE_URL}/toppings/${id}`, {
      headers,
    });
    return response.data;
  },
  ...
  deleteTopping: async (id) => {
    const headers = getAuthHeaders();
    const response = await axios.delete(`${API_BASE_URL}/toppings/${id}`, {
      headers,
    });
    return response.data;
  },
